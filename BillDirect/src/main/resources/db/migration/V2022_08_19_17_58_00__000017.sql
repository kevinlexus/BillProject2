create or replace package body C_CHANGES is
...
return case when p_is_sch in (2) and p_cd in ('х.вода', 'х.вода 0 рег.', 'х.вода/св.нор', 'х.вода.ОДН', 'х.в. ОДН, 0 зарег') and p_sch in (1,2) then 1 --только сч.
                            ...
                            when p_is_sch in (0) and p_cd in ('х.вода', 'х.вода 0 рег.', 'х.вода/св.нор', 'х.вода.ОДН', 'х.в. ОДН, 0 зарег') and p_sch in (0,3) then 1 --без сч.
                            ...
                            when p_l_psch <> 1 and p_cd not in ('х.вода', 'х.вода 0 рег.', 'х.вода/св.нор', 'х.вода.ОДН', 'х.в. ОДН, 0 зарег', 'г.вода',
