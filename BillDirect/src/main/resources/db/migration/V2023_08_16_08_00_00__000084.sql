...
--USING fk_ses_, fk_ses_, mg_, mg_, mg1_, mg1_;
            ...
            open prep_refcursor for select c.name as org1,
                                           ...
                                           s.lsk as lchet2,
                                           'квт.' as ed_izm2,
                                           null as norm2,-- исправил 16.08.23
                                           c6.tf1 as tf_n2,
                                           null as tf_sv2,
                                           e6.test_opl as fakt2,
                                           ...
                                           c8.tf1 as tf_n5,
                                           c8.tf2 as tf_sv5,
                                           null as norm5, -- исправил 14.08.23
                                           e8.test_opl as fakt5, -- исправил 14.08.23
                                           ...
                                           c10.tf1 as tf_n7,
                                           c10.tf2 as tf_sv7,
                                           null as norm7, -- исправил 16.08.23
                                           e10.test_opl as fakt7,
                                           ...
                                           c13.tf2 as tf_sv11,
                                           e13.nrm as norm11,
                                           e13.test_opl as fakt11, -- исправил 14.08.23
       ...
       'выв.мус.', 'выв.мус./св.нор'*/)
                                             ...
                                             left join (select s.lsk,
                                                        ...
                                                        from a_charge2 s
                                                                 ...
                                                                 join usl u
                                                                      on s.usl = u.usl and u.cd in ('г.вода.ОДН', 'GW_SOD') and s.type = 1
                                             ...
                                             left join (select s.lsk,
                                                        ...
                                                        from a_charge2 s
                                                                 ...
                                                                 join usl u on s.usl = u.usl and u.cd in ('канализ.ОДН') and s.type = 1 --канализ МКД
                                                             -- join usl u on s.usl = u.usl and u.cd in ('KAN_SOD') and s.type = 1 --канализ МКД - исправил 14.08.23
