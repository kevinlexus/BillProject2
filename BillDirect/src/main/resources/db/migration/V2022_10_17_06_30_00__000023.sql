create or replace procedure drn133_Реестр_для_УСЗН_для_обм is
begin
Null;
...
begin
Null;
end drnN512_Обор_по_домам_5_1;
/

create or replace procedure drnN521_Обор_по_пост_5_2 is
begin
Null;
end drnN521_Обор_по_пост_5_2;
/

create or replace procedure drnN23_Обор_по_услугам_5_3 is
begin
Null;
