package com.dic.app.gis.sign.commands;

import com.dic.app.gis.sign.exceptions.ElementNotFoundException;
import com.dic.app.gis.sign.jce.KeyLoader;
import com.dic.app.gis.sign.jce.KeyStoreUtils;
import com.dic.app.gis.sign.jce.ProviderFactory;
import com.dic.app.gis.sign.xades.Consts;
import com.dic.app.gis.sign.xades.production.CustomizableXadesBesSigningProfileFactory;
import com.dic.app.gis.sign.xades.providers.CustomizableAlgorithmProvider;
import com.dic.app.gis.sign.xades.providers.CustomizableMessageDigestEngineProvider;
import com.dic.app.gis.sign.xml.IdResolver;
import com.dic.app.gis.sign.xml.XMLParser;
import com.dic.app.gis.sign.xml.XMLPrinter;
...
public class SignCommand implements SignCommands {
    ...
    public SignCommand(String signPass, String signPath) throws Exception {
        ...
        log.info("Keystore provider: " + provider.getName());
        log.info("");

        // выводим список ключей/сертификатов
        log.info("--------------------------------");
        log.info("список ключей/сертификатов:");
...
/*
            ...
            while (aliases2.hasMoreElements()) {
                ...
                if (keyStore.entryInstanceOf(alias, KeyStore.PrivateKeyEntry.class)) {
                    ...
                    log.info("Private key algorithm:"+k.getAlgorithm());
...
*/
            ...
            signer = profile.newSigner();
                ...
                Exception e) {
            log.info("ОШИБКА! Возникла ошибка при загрузке закрытого ключа");
            throw e;
        }
