...
public class NaborMngImpl implements NaborMng {
    ...
    public DetailUslPrice getDetailUslPrice(Kart kartMain, Nabor nabor, BigDecimal amountVol) throws ErrorWhileChrg {
        ...
        if (kartMain.isResidental() && !usl.getFkCalcTp().equals(34)) {
            ...
            if (usl.getFkCalcTp().equals(59)) {
                // Эл.Эн ТСЖ, в зависимости от объема // оставил ветку так 07.12.22, так как отказались от расчета, но код решил сохранить на всякий случ.
            } else {
