...
public class Eolink implements java.io.Serializable  {
	...
	// GUID (Глобальный уникальный идентификатор дома по ФИАС)
	@Column(name = "GUID")
	private String guid;

	// GUID_GIS (Идентификационный код дома в ГИС ЖКХ)
	@Column(name = "GUID_GIS")
	private String guidGis;

	// HM_GUID (Глобальный уникальный идентификатор объекта жилищного фонда)
	@Column(name = "HM_GUID")
	private String hmGUID;
